		...
		<div class="metabox-holder">
			...
			<div class="postbox">
				...
				<div class="inside">
					...
					<p><em><?php _e('You are using Dynamic Content Gallery version ', DFCG_DOMAIN); echo DFCG_VER; _e(' for Wordpress.', DFCG_DOMAIN); ?></em></p>
					<p>
						<ul>
					...
					<p><strong><em><?php _e('Error messages: ', DFCG_DOMAIN); ?></strong><?php _e('In the event of configuration errors, the plugin generates informative error messages in the HTML Source of the page where your gallery is loaded. Please refer to these to assist you with troubleshooting any issues.', DFCG_DOMAIN); ?></em></p>
					<p><?php _e('For further information, see the README.txt document supplied with the plugin or visit the', DFCG_DOMAIN); ?> <a href="http://www.studiograsshopper.ch/dynamic-content-gallery-configuration-guide/">Dynamic Content Gallery configuration guide</a> and comprehensive <a href="http://www.studiograsshopper.ch/dynamic-content-gallery-v3-faq/">FAQ</a>.</p>
					</div>
				...
				<div class="inside">
					...
					<table class="optiontable form-table">
						<tbody>
							...
							<tr valign="top">
								<th scope="row"><input name="dfcg[image-url-type]" style="margin-right:5px;" type="radio" id="dfcg-nourl" value="nourl" <?php checked('nourl', $dfcg_options['image-url-type']); ?> />
									<label for=id="dfcg-nourl">No URL</label></th>
								<td>Enter Custom Field <strong>dfcg-image</strong> in this format: <b><em>myimage.jpg</em></b><br />
								Select this option if all your images are stored in just one folder (ie not the Wordpress default date-based upload folders).<br />
								<em><b>Tip</b>: This is a good option if all your images are stored in one folder within your site.</em></td>
							</tr>
						
							<tr valign="top">
								<th scope="row">URL to images folder:</th>
								<td>If you selected <strong>Partial URL</strong> or <strong>NO URL</strong> above, you must also specify either the URL to the top-level folder which contains the relevant sub-folders and images (Partial URL selected), or the URL to the folder which contains all your images (No URL selected). In either case, include <em>http://www.yourdomain.com/</em> in this URL, for example:<br /><br />
							
								Example 1: If you have selected <b>Partial URL</b> and your images are stored in many folders within a top-level folder, the URL entered here will be: <b><em>http://www.yourdomain.com/top-level-folder/</em></b><br />
								Example 2: If you have selected <b>No URL</b> and your images are stored in their own <em>my_special_image</em> folder in the root of your site, the URL entered here will be: <b><em>http://www.yourdomain.com/myspecial_image_folder/</em></b></td>
							</tr>
				...
				<div class="inside">
					...
					<table class="optiontable form-table"
							<tr valign="top">
								...
								This path should be <b>relative</b> to your site root.  For example, if your default images are stored in a folder named "default" in your http://www.yourdomain.com/wp-content/uploads folder, the path entered here will be: <b><em>/wp-content/uploads/default/</em></b></td>
							</tr>
							<tr valign="top">
								<th scope="row"></th>
					...
					<table class="optiontable form-table">
						<tbody>
							...
							<tr valign="top">
								...
								This path should be relative to your site root.  For example, if your default images are stored in a folder named "default" in your http://www.yourdomain.com/wp-content/uploads folder, the path entered here will be: <b><em>/wp-content/uploads/default/</em></b></td>
							</tr>
							<tr valign="top">
								<th scope="row"></th>
