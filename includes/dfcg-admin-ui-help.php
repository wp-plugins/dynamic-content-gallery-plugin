...
?>
	...
	<div class="help-outer"><h3><?php _e('Dynamic Content Gallery - Quick Help', DFCG_DOMAIN); ?></h3>
		...
		<p><?php _e('The gallery is populated with images which you assign to your posts or pages using a custom field called <strong>dfcg-image</strong> in the relevant posts or pages. The description/text, displayed in the Slide Pane below the post/page title, can be set as an automatically generated excerpt from the relevant posts or pages, or entered manually using a custom field called <strong>dfcg-desc</strong> in the relevant posts or pages.', DFCG_DOMAIN); ?></p>
