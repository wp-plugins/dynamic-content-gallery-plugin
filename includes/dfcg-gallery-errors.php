...
*/
$dfcg_errmsg_1 .= "\n" . $dfcg_errmsg_public . "\n";
$dfcg_errmsg_1 .= '<!-- ' . __('DCG Error Message 1: You have only specified one Page ID in the DCG Settings page.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_1 .= $dfcg_errmsg_critical;
$dfcg_errmsg_1 .= '<!--	' . __('Fix: Enter a minimum of 2 valid Page IDs in the DCG Settings page for the gallery to work.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_2 .= "\n" . $dfcg_errmsg_public . "\n";
$dfcg_errmsg_2 .= '<!-- ' . __('DCG Error Message 2: You have not specified any Page IDs in the DCG Settings page.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_2 .= $dfcg_errmsg_critical;
$dfcg_errmsg_2 .= '<!-- ' . __('Fix: Enter a minimum of 2 valid Page IDs in the DCG Settings page for the gallery to work.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_3 .= '<!-- ' . __('DCG Error Message 3: Custom Field dfcg-desc does not exist and Default Description does not exist.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_3 .= $dfcg_errmsg_noncritical;
$dfcg_errmsg_3 .= '<!--	' . __('Fix: Create a dfcg-desc Custom Field for this Page/Post and/or define a Default Description in the DCG Settings page.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_4 = "\t" . '<!-- ' . __('DCG Error Message 4: Custom Field dfcg-image does not exist and Default Image does not exist.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_4 .= $dfcg_errmsg_noncritical;
$dfcg_errmsg_4 .= "\t" . '<!-- ' . __('Fix: Create a dfcg-image Custom Field for this Page/Post and/or define a Default Image in the DCG Settings page.', DFCG_DOMAIN) .' -->' . "\n";
...
*						
*/
$dfcg_errmsg_5 .= '<!-- ' . __('DCG Error Message 5: Not all of the selected Page IDs are valid Pages.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_5 .= $dfcg_errmsg_noncritical;
$dfcg_errmsg_5 .= '<!-- ' . __('Fix: Check the Page IDs entered in the DCG Settings page.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_6 .= "\n" . $dfcg_errmsg_public . "\n";
$dfcg_errmsg_6 .= '<!-- ' . __('DCG Error Message 6: None of the selected Page IDs are valid Pages or the database query has failed.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_6 .= $dfcg_errmsg_critical;
$dfcg_errmsg_6 .= '<!-- ' . __('Fix: Check the validity of the Page IDs entered in the DCG Settings page. At least 2 Page IDs must be valid.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_6 .= '<!-- ' . __('Fix: If at least 2 of the selected Page IDs are valid, check server error logs.', DFCG_DOMAIN) .' -->';
...
*						
*/
$dfcg_errmsg_7 .= '<!-- ' . __('DCG Error Message 7: You have less Posts in the selected Category than the number specified in the Settings Page.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_7 .= $dfcg_errmsg_noncritical;
$dfcg_errmsg_7 .= '<!-- ' . __('Fix: Reduce the "Number of Posts to display" in the DCG Settings page to match the Number of Posts found.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_8 .= "\n" . $dfcg_errmsg_public . "\n";
$dfcg_errmsg_8 .= '<!-- ' . __('DCG Error Message 8: The wp_query failed to find any Posts.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_8 .= $dfcg_errmsg_critical;
$dfcg_errmsg_8 .= '<!-- ' . __('Fix: Deactivate and reactivate the plugin and try again.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_9 .= "\n" . $dfcg_errmsg_public . "\n";
$dfcg_errmsg_9 .= '<!-- ' . __('DCG Error Message 9: Only one of the Page IDs specified in the DCG Settings page is a valid Page ID in the database.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_9 .= $dfcg_errmsg_critical;
$dfcg_errmsg_9 .= '<!-- ' . __('Fix: Ensure that there are a minimum of 2 valid Page IDs specified in the DCG Settings page.', DFCG_DOMAIN) .' -->';
...
*
*/
$dfcg_errmsg_10 .= '<!-- ' . __('DCG Error Message 10: The plugin is unable to generate any output.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_10 .= $dfcg_errmsg_critical;
$dfcg_errmsg_10 .= '<!-- ' . __('Fix: Check that the plugin has been installed properly and that all files contained within the download ZIP file have been uploaded to your server.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_11 .= "\n" . $dfcg_errmsg_public . "\n";
$dfcg_errmsg_11 .= '<!-- ' . __('DCG Error Message 11: You have defined less than 2 Post Selects in the DCG Settings page.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_11 .= $dfcg_errmsg_critical;
$dfcg_errmsg_11 .= '<!-- ' . __('Fix: Enter a minimum of 2 valid Post Selects in the DCG Settings page for the gallery to work.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_12 .= '<!-- ' . __('DCG Error Message 12: The Post for at least one of your chosen Image Slots could not be found.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_12 .= $dfcg_errmsg_noncritical;
$dfcg_errmsg_12 .= '<!-- ' . __('This could be caused by, for example, defining a Post Select of 4 but only 3 Posts exist in that Category.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_12 .= '<!-- ' . __('Look at the XHTML comments to see which Image # is missing.', DFCG_DOMAIN) .' -->' . "\n"; 
$dfcg_errmsg_12 .= '<!-- ' . __('Fix: Check the Post Select for this missing Image # in the DCG Settings page.', DFCG_DOMAIN) .' -->';
...
*/
$dfcg_errmsg_13 .= "\n" . $dfcg_errmsg_public . "\n";
$dfcg_errmsg_13 .= '<!-- ' . __('DCG Error Message 13: The Post for Image Slot 1 could not be found.', DFCG_DOMAIN) .' -->' . "\n";
$dfcg_errmsg_13 .= $dfcg_errmsg_critical;
$dfcg_errmsg_13 .= '<!-- ' . __('This is because the plugin has set a default category for this Image Slot, but there are no posts in this category.', DFCG_DOMAIN) .' -->' . "\n";
