...
?>
	...
	<p><?php _e( 'This Quick Help provides basic tips, accessed via the menu on the left, to help you understand how the plugin works and how to set up the Settings page. Additionally, detailed guides to Documentation, Configuration and other resources can be found via the links in the sidebar -->', DFCG_DOMAIN ); ?></p>
...
?>
	...
	<p><?php _e( 'There are two methods you can use for integrating (ie displaying) the DCG in your theme - either the DCG Widget or a Template Tag.', DFCG_DOMAIN ); ?></p>
	<h4>DCG Widget</h4>
	...
	<h4><?php _e( 'Template Tag', DFCG_DOMAIN ); ?></h4>
	<p><?php _e( 'For the template tag, add this to your theme:', DFCG_DOMAIN ); ?></p>
	<code>&lt;php dynamic_content_gallery(); ?&gt;</code><br /><br />
	<p><?php _e( 'Check out this tutorial:', DFCG_DOMAIN ); ?> <a class="off-site" target="_blank" href="<?php echo DFCG_HOME; ?>configuration-guide/#template-code"><?php _e( 'How to choose the correct theme template when adding the plugin code', DFCG_DOMAIN ); ?></a></p>
...
?>
	...
	<p><?php _e( 'Note: it is quite possible that the manual image management options will be removed in future. Therefore users are encouraged to use the Featured Image option - it is easier and more flexible.', DFCG_DOMAIN ); ?></p>
