...
* Compatible with Wordpress Mu to 2.6.5 (note that some Settings are not available when used with Wordpress Mu)
...
* The plugin has been tested for compatibility with Wordpress 2.7.
